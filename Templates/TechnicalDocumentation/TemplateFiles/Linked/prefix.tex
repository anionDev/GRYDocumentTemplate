...
\usepackage[backend=biber]{biblatex}%Required for "biber" to print the bibliography
\usepackage{lipsum}%Required to be able to print "Lorem ipsum"-texts
\usepackage{titlesec}%Required to be able for format headings.
...
\input{other/additionalpreamble.tex}
